...
TTL decided_at + INTERVAL 2 YEAR
...
TTL reported_at + INTERVAL 3 YEAR;
...
SELECT
    ...
    countIf(action = 'STEP_UP')                         AS step_up,
    countIf(action = 'REVIEW')                          AS manual_review,
    count()                                             AS total,
