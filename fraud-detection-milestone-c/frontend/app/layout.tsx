...
import {
  Activity, BarChart2, Clock, FileSearch, Home,
...
const NAV: { label: string; href: string; icon: React.FC<any>; roles: Role[] }[] = [
  ...
  { label: 'Live Feed',    href: '/live-feed',    icon: Activity,   roles: ['ANALYST','OPS_MANAGER','ADMIN','BANK_PARTNER'] },
      ...
      `}>
        ...
        <div className="flex items-center justify-between px-4 py-5 border-b border-gray-700">
          <div className="flex items-center gap-2">
            <Image src="/ritam-guard-logo.png" alt="Ritam Guard" width={24} height={24} className="w-6 h-6 rounded-md object-cover" priority />
          ...
          <div className="flex h-screen overflow-hidden">
            ...
            <div className="flex-1 flex flex-col overflow-hidden">
              ...
              <header className="flex items-center gap-3 px-4 py-3 bg-white border-b border-gray-200 lg:hidden">
                ...
                <Image src="/ritam-guard-logo.png" alt="Ritam Guard" width={20} height={20} className="w-5 h-5 rounded-md object-cover" priority />
